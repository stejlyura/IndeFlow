    ...
    <div class="container mx-auto max-w-6xl grid lg:grid-cols-2 gap-24">
        ...
        <div class="p-8 md:p-12 sharp border bg-zinc-950 text-white border-zinc-800">
            <form class="space-y-12" onsubmit={(e) => e.preventDefault()}>
                ...
                <input type="text" placeholder="COMPANY NAME" class="input-premium w-full text-xs uppercase font-bold" aria-label="Company Name">
                <div class="grid md:grid-cols-2 gap-10">
                    <div class="flex flex-col">
                        <label for="budget" class="text-[9px] uppercase mb-4 opacity-60">Budget</label>
                        <select id="budget" class="bg-transparent border-b border-zinc-800 py-3 text-xs uppercase font-bold outline-none cursor-pointer">
                            <option value="1" class="bg-zinc-950">40,000 - 150,000 ₴</option>
                            <option value="2" class="bg-zinc-950">150,000+ ₴</option>
                        </select>
                    </div>
                    <div class="flex flex-col">
                        <label for="deadline" class="text-[9px] uppercase mb-4 opacity-60">Deadline</label>
                        <input id="deadline" type="date" class="bg-transparent border-b border-zinc-800 py-3 text-xs uppercase font-bold outline-none invert">
                    </div>
                </div>
